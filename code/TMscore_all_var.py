    ...
    def __init__(self, pdb1, pdb1_name, pdb2, pdb2_name, nMSA, option, model_type):
        ...
        if model_type != "alphafold2_multimer_v3":
            ...
            for multi in (1, 2, 2, 2, 2, 2, 2):
                ...
                pred_dir = 'predictions_all/' + pdb1_name + "/" + pdb1_name + '_predicted_models_rand_*' + '_max_' + str(max_msa) + '_ext_' + str(ext_msa) + '/'; print(pred_dir)
            ...
            if np.all(TMscores_random_alter) < 0.5:
                ...
                MSA_shallow_TMscore.select_size(TMscores_random_reshape, pdb1_name, pdb2_name, alt_name, num_seeds)
