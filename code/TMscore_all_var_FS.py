...
class TMscore_cal_all_var_FS():
    def __init__(self, pdb1, pdb1_name, pdb2, pdb2_name, nMSA, option, model_type, seq):
        ...
        if model_type != "alphafold2_multimer_v3":
            ...
            pred_dir = 'predictions_all/' + pdb1_name + "/" + pdb1_name + "_predicted_models_full_rand_*"
            ...
            for multi in (1, 2, 2, 2, 2, 2, 2):
                ...
                pred_dir = 'predictions_all/' + pdb1_name + "/" + pdb1_name + '_predicted_models_rand_*_max_' + str(max_msa) + '_ext_' + str(ext_msa)
            ...
            if np.any(TMscores_random_alter > 0.5) and np.any(TMscores_fs_random_alter > 0.45):
                ...
                MSA_shallow_TMscore.select_size(TMscores_random_reshape, TMscores_fs_random_reshape, pdb1_name, pdb2_name, alt_name, num_seeds)
                size_selection = MSA_shallow_TMscore.selection; self.size_selection = size_selection
