...
if __name__ == "__main__":
    ...
    ##### output folder name designation
    if args.option == "blind":
        if args.pdb1 is None and args.pdb2 is None:
            ...
            pdb1_name = args.fname; pdb1_name = pdb1_name.replace('/','')
            print("work name:", pdb1_name)
        else:
            pdb1_name = args.fname; pdb1_name = pdb1_name.replace('/','')
            print("work name:", pdb1_name)
    ...
    ##### Checking input MSA folder 
    if args.fname is None and args.fmname is None:
        print("Please put MSA folder and file for prediction")
        sys.exit()
        ...
        search_dir = args.fname; search_multi_dir = 0
    elif args.fname is not None and args.fmname is not None:
        search_dir = args.fname; search_multi_dir = ' ' + args.fmname;
    ...
    if args.option == "AC":
        ...
        ###### running prediction using full- and shallow random-MSA
        blind_pred_path = 'predictions_all/' + pdb1_name; print(blind_pred_path)
