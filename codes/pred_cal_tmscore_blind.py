...
class CF_MSA_var():
    def __init__(self, pdb1_name, search_dir, output_dir, rseed, num_seeds):
        #### shallow MSA section
        #### Global viarlable
        max_msa = 1
        ext_msa = 2
...
class prediction_all_blind():
    def __init__(self, pdb1_name, search_dir, nMSA):
        ...
        MSA_var = CF_MSA_var(pdb1_name, search_dir, output_dir, random_seed, num_seeds)
