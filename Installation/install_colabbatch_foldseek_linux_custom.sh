...
# "$COLABFOLDDIR/colabfold-conda/bin/pip" install --upgrade tensorflow[and-cuda]
# "$COLABFOLDDIR/colabfold-conda/bin/pip" install silence_tensorflow

"$COLABFOLDDIR/colabfold-conda/bin/pip" install --upgrade "jax[cuda12_pip]==0.4.23" -f https://storage.googleapis.com/jax-releases/jax_cuda_releases.html
"$COLABFOLDDIR/colabfold-conda/bin/pip" install "colabfold[alphafold]"
"$COLABFOLDDIR/colabfold-conda/bin/pip" install --upgrade tensorflow[and-cuda]
"$COLABFOLDDIR/colabfold-conda/bin/pip" install silence_tensorflow
